...
import { Stage, Clicker, Essence, DataSource, Filter, Dimension, DragPosition, NEVER_BUCKET } from '../../../common/models/index';
  ...
  render() {
    ...
    if (dimension.kind === 'time') {
      ...
      menuCont = <TimeFilterMenu
        ...
        onClose={onClose}
      />;
    } else if (dimension.kind === 'number' && dimension.bucketingStrategy !== NEVER_BUCKET) {
      menuSize = Stage.fromSize(250, 274);
